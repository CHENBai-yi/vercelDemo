...
import BitGit from "../../components/Svg/Icons/BitGit";
...
const connectors: Config[] = [
  ...
  },
  {
    ...
    connectorId: ConnectorNames.Injected,
    // @ts-ignore
    installed: typeof window !== "undefined" && Boolean(window.ethereum?.isBitGit),
    priority: () => {
      // @ts-ignore
      return typeof window !== "undefined" && Boolean(window.ethereum?.isBitGit) ? 0 : 999;
    },
    href: "https://web3.bitget.com/zh-CN/wallet-download?",
  },
];

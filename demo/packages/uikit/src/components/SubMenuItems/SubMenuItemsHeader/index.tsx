...
import MenuItem from "../../MenuItem/MenuItemHeader";
    ...
    <SubMenuItemWrapper $isMobileOnly={isMobileOnly} {...props}>
      ...
      >
        {items.map(({ label, href, icon, itemProps, type, disabled }) => {
          ...
          return (
            label && (
              <StyledSubMenuItemWrapper key={label} mr="10px">
                <MenuItem
                  href={href}
                ...
                >
                  ...
                  {isActive && (
                    <Image
                      style={{ flexShrink: 0 }}
                      src={`/newimages/${activeItem}.png`}
                      width={24}
                      height={24}
                      mr="10px"
                    />
                  )}
                  <div style={{ color: isActive ? "#000" : "" }}>{label}</div>
                  {isExternalLink && (
